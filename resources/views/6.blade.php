...
<body>
   ...
   <div class = "akk">
   <form method="POST" action="{{ route('6')}}">
        @csrf
        <h1>Создайте аккаунт</h1>
        <input class="rgo" type="text" name="имя" placeholder="имя">
        <input class="rgo"type="text" name="фамилия"placeholder="фамилия" >
        <input class="rgo"type="number" name="номер" placeholder="номер">
        
        <button class="rgo" type="submit">создать</button>
    </form>
    </div>
